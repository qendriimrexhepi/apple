...
session_start();
   ...
   $query = $pdo->query('SELECT * FROM posts inner join news_category on news_category.category_id = posts.category_id WHERE news_category.category_id = 2');
                ...
                <div class="section flex flex-flow justify-content align-items">
                    ...
                    <figure  class="figure">
                        <a href="showmore.php?posts_id=<?php echo $news['posts_id']; ?>">
                            <img src="<?php echo $news['image']; ?>" class="watches" alt="watches"/>
                        </a>
